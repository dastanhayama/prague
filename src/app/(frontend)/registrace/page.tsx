...
export default function LoginPage() {
  ...
  const confettiTitleClasses =
    'mt-2xl mb-xs text-[#101828] text-[24px] leading-[32px] font-semibold text-center'
  const confettiSubtitleClasses = 'text-[#475467] text-[16px] leading-[24px] text-center'
  const confettiButtonContainerClasses =
    'w-full mt-3xl tablet:mt-3xl fixed bottom-3xl left-0 right-0 px-xl tablet:relative tablet:bottom-auto tablet:left-auto tablet:right-auto tablet:px-0'
    ...
    <div className={containerClasses}>
      {steps !== 'confetti' ? (
        ...
        <div className={confettiContentClasses}>
          ...
          <p className={confettiTitleClasses}>Gratulujeme</p>
