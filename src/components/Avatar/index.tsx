...
const Avatar: React.FC<AvatarProps> = ({
  ...
  const placeholderContainerClasses = 'w-full h-full bg-[#F2F4F7] flex items-center justify-center'
        ...
        <div className={gradientContainerClasses}>
          ...
          <div className={avatarContainerClasses}>
            {placeholder || text ? (
              ...
              <img src={avatar} alt="Avatar" className="w-full h-full object-cover object-center" />
            )}
          </div>
        </div>
